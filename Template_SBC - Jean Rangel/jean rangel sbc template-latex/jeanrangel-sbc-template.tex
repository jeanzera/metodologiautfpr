...
\begin{table}[!h]
	...
	\begin{tabular}{lll}
		...
		Áreas & Autores  \\
		\noalign{\smallskip}\hline\noalign{\smallskip}
		Bancos ou cartões de crédito & \cite{Abdallah2016}, \cite{Bansal2016}, \cite{Ahmed2015},  &  \\
		& \cite{Edge2009}, \cite{Allan2010},  &  \\
		& \cite{Pejic-Bach2010}, \cite{Raj2011}, \cite{Perlich2007},  &  \\
		& \cite{Kanapickiene2015}, \cite{Branco2016},  &  \\
		& \cite{Akoglu2015}  &  \\
		...
		Telecomunicação & \cite{Abdallah2016}, \cite{Ahmed2015}, &  \\
		& \cite{Allan2010},  &  \\
		...
		& \cite{Pejic-Bach2010}, \cite{Wang2010}, \cite{Branco2016},  &  \\
		& \cite{Akoglu2015}  &  \\
